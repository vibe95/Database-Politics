--Scenario: with 3 parties, and 2 elections. 2 parties in the first election. all parites are in the second elections
...
insert into	election_result values (4, 1, 2, NULL, 300, 12000000, 'd1');
